# Lesson Plan: Product of Array Except Self (LC #238)
...
## Output file
`lessons/product-of-array-except-self/lesson.html` — self-contained, offline-capable, no CDN dependencies.
