# Lesson Plan: Reverse Linked List (LC #206)
...
- **DS:** linked list → load `skills/ds/linked_list.md`
- **Pattern:** (identify from problem)

## Skill files to load into context
1. `skills/ds/linked_list.md`

## Output file
`lessons/reverse-linked-list/lesson.html` — self-contained, offline-capable, no CDN dependencies.
